...
package com.benkkstudio.beebotomnavigation
...
internal typealias IBottomNavigationListener = (model: BeeBottomNavigation.Model) -> Unit

@Suppress("MemberVisibilityCanBePrivate")
class BeeBottomNavigation : FrameLayout {

    var models = ArrayList<Model>()
    internal var cells = ArrayList<BeeBottomNavigationCell>()
        private set
    ...
    private fun initializeViews() {
        ...
        bezierView.apply {
            ...
            shadowColor = this@BeeBottomNavigation.shadowColor
        }
    ...
    fun add(model: Model) {
        val cell = BeeBottomNavigationCell(context)
        cell.apply {
            val params = LinearLayout.LayoutParams(0, heightCell, 1f)
            layoutParams = params
            icon = model.icon
            count = model.count
            defaultIconColor = this@BeeBottomNavigation.defaultIconColor
            selectedIconColor = this@BeeBottomNavigation.selectedIconColor
            circleColor = this@BeeBottomNavigation.circleColor
            countTextColor = this@BeeBottomNavigation.countTextColor
            countBackgroundColor = this@BeeBottomNavigation.countBackgroundColor
            countTypeface = this@BeeBottomNavigation.countTypeface
            rippleColor = this@BeeBottomNavigation.rippleColor
            onClickListener = {
    ...
    private fun anim(cell: BeeBottomNavigationCell, id: Int, enableAnimation: Boolean = true) {
        isAnimating = true
    ...
    internal fun getCellById(id: Int): BeeBottomNavigationCell {
    ...
    fun clearCount(id: Int) {
        val model = getModelById(id) ?: return
        val pos = getModelPosition(id)
        model.count = BeeBottomNavigationCell.EMPTY_VALUE
        cells[pos].count = BeeBottomNavigationCell.EMPTY_VALUE
    }
    ...
    class Model(var id: Int, var icon: Int) {
        ...
        var count: String = BeeBottomNavigationCell.EMPTY_VALUE
